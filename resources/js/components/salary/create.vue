       ...
       <div class="row container">
         <div class="card col-lg-12 border-primary shadow">
          <div class="card-header text-primary" style="font-size: 20px; font-weight: 700;">
            ...
            {{$t('salary.pay')}}
            <router-link to="/given-salary" class="btn btn-primary" id="add_new"> {{$t('salary.salaries')}}</router-link>
          </div>
          ...
          <div class="card-body">
	          ...
	          <div class="form-group">
               ...
               <button type="submit" class="btn btn-success">{{$t('salary.pay_now')}}</button>
              </form>
          </div>
         </div>
       </div>
