                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <!-----Search----->
                            <input type="text" v-model="searchTerm" class="form-control" :placeholder="$t('form.search_here')"><br>
                            <div class="row">
                                    ...
                                    <button v-if="getproduct.product_quantity >= 1" class="btn btn-sm" @click.prevent="AddToCart(getproduct.id)">
                                        <div class="card" style="width: 9rem; height: 180px;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <span class="badge badge-success" v-if="getproduct.product_quantity >= 1"> {{$t('product.available')}} ({{ getproduct.product_quantity }}) </span>
                                                <span class="badge badge-danger" v-else>{{$t('product.stock_out')}}</span>
